...
export default function Sale() {
  ...
  return (
    <>
      ...
      {openModal && <AddModal openModal={openModal} setOpenModal={setOpenModal} title={singleData?.id ? 'Edit Customer' : 'Add Customer'} singleData={singleData} setSingleData={setSingleData} />}
    </>
  );
}
