...
export default function Service({products}) {
  return (
    <section id="products" className="py-20 bg-muted/30">
    <div className="container mx-auto px-4">
      <div className="text-center mb-16">
        <Badge className="mb-4">Our Accessories</Badge>
        <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">LPG Accessories You Can Rely On</h2>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        Explore our wide range of high-quality LPG accessories, including stoves, regulators, hoses, and more. Designed for safety, durability, and efficiency, our products make your cooking experience smooth and hassle-free.
        </p>
      </div>
        ...
        {products?.map((cylinder, index) => (
          <Card key={index} className="relative hover:shadow-lg transition-shadow">
            ...
            <CardFooter>
              ...
              <a href="tel:01792429367">Buy Now</a>
              </Button>
            </CardFooter>
          </Card>
        ))}
